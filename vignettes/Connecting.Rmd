...
##  Obtaining drivers for SQLite, ClickHouse or DuckDb

For SQLite, ClickHouse and DuckDb we actually don't use a JDBC driver. Instead, we use the RSQLite, RClickhouse and duckdb packages, respectively, which can be installed using 
